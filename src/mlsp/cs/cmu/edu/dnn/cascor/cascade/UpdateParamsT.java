...
public class UpdateParamsT {
	...
	public double epsilon;		/* Learning rate parameter.  Higher rates can decrease    */
    							/* training time, but may cause learning to go unstable   */
	public double mu;			/* Maximum step size parameter as described by Fahlman    */
    							/* in the Quickprop paper [1].  Usually not worth tuning  */
	public double decay;		/* Weight decay.  Causes weights to decay towards zero.   */
